...
GITHUB_TOKEN = os.environ.get("GITHUB_TOKEN", "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")
...
def do_youtube_upload(file_path, title, description, tags, category, file_hash, filename):
